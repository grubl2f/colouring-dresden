...
interface DatePickerDataEntryProps extends BaseDataEntryProps {
    value?: string;
    placeholder?: string;
    min?: string;
    max?: string;
...
const DatePickerDataEntry: React.FunctionComponent<DatePickerDataEntryProps> = (props) => {
...
export default DatePickerDataEntry;
